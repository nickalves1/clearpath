...
class PatientsRepositoryTest extends TestCase
{
    ...
    public function test_paginate_filters_patients_by_gender(): void
    {
        $male = Patient::factory()->create(['gender' => 'Male']);
        $female = Patient::factory()->create(['gender' => 'Female']);

        $result = (new PatientsRepository)->paginate(['filters' => ['gender' => 'Male']]);
        $ids = $result->pluck('id');
    ...
    public function test_paginate_filters_patients_by_active_status(): void
    {
        $active = Patient::factory()->create();
        $inactive = Patient::factory()->create();
        $inactive->delete();

        $result = (new PatientsRepository)->paginate(['filters' => ['is_active' => 'true']]);
        $ids = $result->pluck('id');
    ...
    public function test_paginate_filters_patients_by_inactive_status(): void
    {
        $active = Patient::factory()->create();
        $inactive = Patient::factory()->create();
        $inactive->delete();

        $result = (new PatientsRepository)->paginate(['filters' => ['is_active' => 'false']]);
        $ids = $result->pluck('id');
    ...
    public function test_paginate_hides_deleted_patients_by_default(): void
    {
        $active = Patient::factory()->create();
        $deleted = Patient::factory()->create();
        $deleted->delete();

        $result = (new PatientsRepository)->paginate([]);
        $ids = $result->pluck('id');
    ...
    public function test_paginate_filters_patients_by_created_at_custom_range(): void
    {
    ...
    public function test_paginate_filters_patients_deleted_today(): void
    {
    ...
    public function test_paginate_searches_patients_by_name(): void
    {
        ...
        $result = (new PatientsRepository)->paginate(['search' => 'nicolas']);
        $ids = $result->pluck('id');
    ...
    public function test_paginate_searches_patients_by_medical_record_number(): void
    {
        $match = Patient::factory()->create([
            'first_name' => 'Nicolas',
            'last_name' => 'Alves',
        ...
        $result = (new PatientsRepository)->paginate(['search' => '99999']);
        $ids = $result->pluck('id');
